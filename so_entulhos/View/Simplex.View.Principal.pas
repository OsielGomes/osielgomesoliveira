...
uses
  ...
  Unit1, Fundo.View.Padrao, Simplex.View.Principal2;

{$R *.dfm}

procedure TfrmPrincipal.ApplicationEventsModalBegin(Sender: TObject);
begin
  frmFundo.Show;
end;

procedure TfrmPrincipal.ApplicationEventsModalEnd(Sender: TObject);
begin
  frmFundo.Hide;
end;
...
begin
  frmCadastros := TfrmClientes.GetInstance;
  frmCadastros.Parent := pnlForm;
  frmCadastros.Show;
