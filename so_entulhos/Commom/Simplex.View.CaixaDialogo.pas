unit Simplex.View.CaixaDialogo;
...
type
  TfrmCaixaDialogo = class(TForm, iMessageDialog, iButtons)
    ...
    procedure btnOkCardOkCancelClick(Sender: TObject);
    procedure btnCancelCardOkCancelClick(Sender: TObject);
    procedure btnNoCardYesNoClick(Sender: TObject);
    procedure btnYesCardYesNoClick(Sender: TObject);
  private
    FMessage: String;
  public
...
procedure TfrmCaixaDialogo.btnCancelCardOkCancelClick(Sender: TObject);
begin
  Close;
  ModalResult := mrCancel;
end;

procedure TfrmCaixaDialogo.btnNoCardYesNoClick(Sender: TObject);
begin
  Close;
  ModalResult := mrNo;
end;

procedure TfrmCaixaDialogo.btnOkCardOkCancelClick(Sender: TObject);
begin
  Close;
  ModalResult := mrOk;
end;
...
procedure TfrmCaixaDialogo.btnYesCardYesNoClick(Sender: TObject);
begin
  Close;
  ModalResult := mrYes;
end;
...
//function TfrmCaixaDialogo.ModalResult: TModalResult;
//begin
////  case TModalResult
//end;
